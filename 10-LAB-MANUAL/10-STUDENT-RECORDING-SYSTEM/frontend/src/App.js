...
const App = () => {
  ...
  // Delete student and update UI optimistically
  const deleteStudent = async (id) => {
    try {
      await axios.delete(`http://127.0.0.1:5000/api/students/${id}`);
      // Optimistically remove the student from the state
  ...
  return (
    <div className="App">
      <header className="App-header">
        <img src="/Pateros.png" alt="Pateros Logo" className="pateros-logo" />
